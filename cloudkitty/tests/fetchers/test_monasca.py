...
class MonascaFetcherTest(tests.TestCase):
    ...
    def setUp(self):
        ...
        self.conf.set_override('dimension_name', 'dimenstion_name_test',
                               'fetcher_monasca')
        self.conf.set_override('monasca_tenant_id', 'this_is_definitly_an_uid',
                               'fetcher_monasca')
    ...
    def test_get_tenants(self):
        with mock.patch.object(self.fetcher._conn.metrics,
            ...
            m.assert_called_once_with(
                tenant_id='this_is_definitly_an_uid',
                dimension_name='dimenstion_name_test',
            )
